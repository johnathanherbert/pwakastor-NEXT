  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 
                    border border-blue-100 dark:border-blue-800/50 rounded-xl overflow-hidden shadow-sm">
        <div className="grid md:grid-cols-3 gap-4 p-5">
          <div className="col-span-1">
            <h3 className="text-lg font-bold text-blue-800 dark:text-blue-300 mb-1">
              {selectedExcipient}
            </h3>
            <p className="text-xs text-blue-600/80 dark:text-blue-400/80 uppercase font-medium tracking-wide">
