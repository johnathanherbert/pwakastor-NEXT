...
export default function OEECabine1() {
  ...
  const handleIniciarAmostragem = async () => {
    ...
    try {
      // Atualizar todos os itens da NT para status "Em Amostragem" e alocar para a cabine 1
      const now = new Date();
  ...
  const handleFinalizarAmostragem = async () => {
    try {
      ...
      showToast("Cabine 1 está disponível para nova amostragem", "info", 5000);
    } catch (error) {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
      <Topbar 
        ...
        title="OEE de Amostragem - Cabine 1"
      />
      
      <main className="pt-20 px-6 max-w-7xl mx-auto pb-12">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-white flex items-center">
            <BeakerIcon className="h-7 w-7 mr-2 text-blue-600 dark:text-blue-400" />
            OEE de Amostragem - Cabine 1
          </h1>
                        ...
                        <div className="flex justify-end">
                          <button
                            ...
                            className="px-3 py-1.5 text-xs font-medium bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400
                                    rounded-md hover:bg-blue-100 dark:hover:bg-blue-800/40 transition-colors
